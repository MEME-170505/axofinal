              ...
              <div class="image-upload-container">
                ...
                >
                  <div v-if="!previewImage" class="upload-placeholder">
                    ...
                    <p class="mb-0 mt-2">Click para cambiar imagen</p>
                  </div>
...
// Watch para cargar datos del servicio cuando se abre el modal
watch(() => props.servicio, (newServicio) => {
  if (newServicio) {
    formData.value = {
      id: newServicio.id,
      title: newServicio.title || newServicio.name,
      description: newServicio.description,
      price: parseFloat(newServicio.price?.replace(/[^0-9]/g, '') || 0),
      image: newServicio.image
    }
    previewImage.value = newServicio.image || null
  }
}, { immediate: true })
...
const handleSubmit = () => {
  const serviceData = {
    ...
    price: `$${formData.value.price} MXN`,
